...
- `rules/acl4ssr-*.yaml` stores the ACL4SSR Clash `.list` variants. Full/Core use DustinWin `fakeip-filter` as the shared fake-ip compatibility provider, plus ACL4SSR MRS domain providers for private/domestic DNS rules.
