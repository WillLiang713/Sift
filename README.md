...
| [`rules/ACL4SSR-full.yaml`](./rules/ACL4SSR-full.yaml) | 18 | 28 | ACL4SSR 规则集完整版：含 `谷歌服务`；流媒体用 ACL 分服务包（YouTube/Netflix/Disney+/Spotify/TikTok，非 ProxyMedia）；保留 AI、游戏、Telegram、Apple、Microsoft、OneDrive、地区节点及 DNS/嗅探 |
